  ...
  <div class="border rounded p-4">
    ...
    <form action="/livro/novo" method="POST">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" id="name" placeholder="Nome do livro">
      </div>
      <br>
      <div class="form-group">
        <label for="nameAuthor">Autor</label>
          <input type="text" class="form-control" name="nameAuthor" id="nameAuthor" placeholder="Nome do Autor">
      </div>
      <br>
      <div class="form-group">
